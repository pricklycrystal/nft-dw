...
const projectId = 'd514ad84dd89c9053bd6912599458e58';
const projectSecretKey = '4d7034613fc252eeac6fd1cf1bd3d9ca';
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain ='https://diplomawork-nft-marketplace.infura-ipfs.io';
...
export const NFTMarketplaceProvider = ({ children }) => {
  const titleData = "Создай свою соллекцию NFT";
